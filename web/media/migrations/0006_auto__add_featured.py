...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'media_featured', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True)),
            ('ftype', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('published', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Page'], null=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bmabru.Project'], null=True, blank=True)),
        ))
        db.send_create_signal(u'media', ['Featured'])


    def backwards(self, orm):
        # Deleting model 'Featured'
        db.delete_table(u'media_featured')
