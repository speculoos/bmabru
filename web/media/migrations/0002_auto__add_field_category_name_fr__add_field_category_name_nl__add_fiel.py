...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'media_category', 'name_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.name_nl'
        db.add_column(u'media_category', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.title_fr'
        db.add_column(u'media_page', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.title_nl'
        db.add_column(u'media_page', 'title_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.body_fr'
        db.add_column(u'media_page', 'body_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.body_nl'
        db.add_column(u'media_page', 'body_nl',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'media_category', 'name_fr')

        # Deleting field 'Category.name_nl'
        db.delete_column(u'media_category', 'name_nl')

        # Deleting field 'Page.title_fr'
        db.delete_column(u'media_page', 'title_fr')

        # Deleting field 'Page.title_nl'
        db.delete_column(u'media_page', 'title_nl')

        # Deleting field 'Page.body_fr'
        db.delete_column(u'media_page', 'body_fr')

        # Deleting field 'Page.body_nl'
        db.delete_column(u'media_page', 'body_nl')
