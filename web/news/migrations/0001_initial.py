...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_resource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'news', ['Resource'])
        ...
        db.create_table(u'news_item', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, blank=True, to=orm['bmabru.Project'])),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['news.Resource'], null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'news_resource')
    ...
    models = {
        ...
        u'news.item': {
            ...
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['news.Resource']", 'null': 'True', 'blank': 'True'}),
