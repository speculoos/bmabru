...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'news_resource', 'slug')

        # Deleting field 'Resource.image'
        db.delete_column(u'news_resource', 'image')

        # Deleting field 'Resource.width'
        db.delete_column(u'news_resource', 'width')

        # Deleting field 'Resource.height'
        db.delete_column(u'news_resource', 'height')
