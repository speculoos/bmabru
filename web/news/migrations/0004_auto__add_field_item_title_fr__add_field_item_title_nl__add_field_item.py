...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.title_fr'
        db.add_column(u'news_item', 'title_fr',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.title_nl'
        db.add_column(u'news_item', 'title_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.body_fr'
        db.add_column(u'news_item', 'body_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.body_nl'
        db.add_column(u'news_item', 'body_nl',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.title_fr'
        db.delete_column(u'news_item', 'title_fr')

        # Deleting field 'Item.title_nl'
        db.delete_column(u'news_item', 'title_nl')

        # Deleting field 'Item.body_fr'
        db.delete_column(u'news_item', 'body_fr')

        # Deleting field 'Item.body_nl'
        db.delete_column(u'news_item', 'body_nl')
