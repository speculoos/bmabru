...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bmabru_project', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bmabru.Project'], null=True))

    def backwards(self, orm):

        # Changing field 'Project.parent'
        db.alter_column(u'bmabru_project', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bmabru.Project']))
