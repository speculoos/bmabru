...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field trade_object on 'Project'
        db.create_table(u'bmabru_project_trade_object', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'bmabru.project'], null=False)),
            ('tradeobject', models.ForeignKey(orm[u'bmabru.tradeobject'], null=False))
        ))
        db.create_unique(u'bmabru_project_trade_object', ['project_id', 'tradeobject_id'])


    def backwards(self, orm):
        # Adding field 'Project.trade_object'
        db.add_column(u'bmabru_project', 'trade_object',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bmabru.TradeObject'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field trade_object on 'Project'
        db.delete_table('bmabru_project_trade_object')
