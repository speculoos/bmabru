...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectWorth'
        db.create_table(u'bmabru_projectworth', (
        ...
        db.send_create_signal(u'bmabru', ['ProjectWorth'])

        # Adding model 'TradeObject'
        db.create_table(u'bmabru_tradeobject', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('name_fr', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('name_nl', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ...
        db.send_create_signal(u'bmabru', ['TradeObject'])

        # Adding field 'Project.trade_name'
        db.add_column(u'bmabru_project', 'trade_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Project.attribution'
        db.add_column(u'bmabru_project', 'attribution',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Project.trade_object'
        db.add_column(u'bmabru_project', 'trade_object',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bmabru.TradeObject'], blank=True),
                      keep_default=False)

        # Adding field 'Project.parent'
        db.add_column(u'bmabru_project', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['bmabru.Project'], blank=True),
                      keep_default=False)

        # Adding M2M table for field worth on 'Project'
        db.create_table(u'bmabru_project_worth', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'bmabru.project'], null=False)),
            ('projectworth', models.ForeignKey(orm[u'bmabru.projectworth'], null=False))
        ))
        db.create_unique(u'bmabru_project_worth', ['project_id', 'projectworth_id'])


    def backwards(self, orm):
        # Deleting model 'ProjectWorth'
        db.delete_table(u'bmabru_projectworth')

        # Deleting model 'TradeObject'
        db.delete_table(u'bmabru_tradeobject')

        # Deleting field 'Project.trade_name'
        db.delete_column(u'bmabru_project', 'trade_name')

        # Deleting field 'Project.attribution'
        db.delete_column(u'bmabru_project', 'attribution')

        # Deleting field 'Project.trade_object'
        db.delete_column(u'bmabru_project', 'trade_object_id')

        # Deleting field 'Project.parent'
        db.delete_column(u'bmabru_project', 'parent_id')

        # Removing M2M table for field worth on 'Project'
        db.delete_table('bmabru_project_worth')
    ...
    models = {
        ...
        u'bmabru.project': {
            ...
            'actions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bmabru.Action']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'description_fr': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'description_nl': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'functions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bmabru.Function']", 'symmetrical': 'False', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'procedure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bmabru.Procedure']", 'blank': 'True'}),
            'programs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bmabru.Program']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'trade_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bmabru.TradeObject']", 'blank': 'True'}),
            'worth': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bmabru.ProjectWorth']", 'symmetrical': 'False', 'blank': 'True'})
        },
