...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'City.geom'
        db.alter_column(u'bmabru_city', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

    def backwards(self, orm):

        # Changing field 'City.geom'
        db.alter_column(u'bmabru_city', 'geom', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
    ...
    models = {
        ...
        u'bmabru.city': {
            ...
            'geom': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'bmabru.projectimage': {
            ...
            'zoom_level': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'})
        },
