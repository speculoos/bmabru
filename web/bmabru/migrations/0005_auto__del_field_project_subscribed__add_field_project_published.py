...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.subscribed'
        db.delete_column(u'bmabru_project', 'subscribed')

        # Adding field 'Project.published'
        db.add_column(u'bmabru_project', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.subscribed'
        db.add_column(u'bmabru_project', 'subscribed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Project.published'
        db.delete_column(u'bmabru_project', 'published')
