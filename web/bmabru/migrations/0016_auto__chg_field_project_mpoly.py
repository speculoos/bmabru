...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.mpoly'
        db.alter_column(u'bmabru_project', 'mpoly', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, geography=True))

    def backwards(self, orm):

        # Changing field 'Project.mpoly'
        db.alter_column(u'bmabru_project', 'mpoly', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(default=None, geography=True))
