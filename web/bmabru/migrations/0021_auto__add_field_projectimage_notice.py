...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectImage.notice'
        db.add_column(u'bmabru_projectimage', 'notice',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectImage.notice'
        db.delete_column(u'bmabru_projectimage', 'notice')
