...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'City'
        db.create_table(u'bmabru_city', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('name_fr', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('name_nl', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'bmabru', ['City'])


        # Renaming column for 'Project.city' to match new field type.
        #db.rename_column(u'bmabru_project', 'city', 'city_id')
        db.delete_column(u'bmabru_project', 'city')
        # Changing field 'Project.city'
        db.add_column(u'bmabru_project', 'city_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
        db.alter_column(u'bmabru_project', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bmabru.City']))
        # Adding index on 'Project', fields ['city']
        db.create_index(u'bmabru_project', ['city_id'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['city']
        db.delete_index(u'bmabru_project', ['city_id'])

        # Deleting model 'City'
        db.delete_table(u'bmabru_city')


        # Renaming column for 'Project.city' to match new field type.
        db.rename_column(u'bmabru_project', 'city_id', 'city')
        # Changing field 'Project.city'
        db.alter_column(u'bmabru_project', 'city', self.gf('django.db.models.fields.CharField')(max_length=128))
