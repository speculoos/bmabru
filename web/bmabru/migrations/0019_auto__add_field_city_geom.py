...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bmabru_city', 'geom',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'bmabru_city', 'geom')
    ...
    models = {
        ...
        u'bmabru.city': {
            ...
            'geom': ('django.contrib.gis.db.models.fields.PolygonField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
