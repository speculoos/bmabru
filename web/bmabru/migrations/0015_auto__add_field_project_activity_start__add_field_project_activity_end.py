...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.activity_start'
        db.add_column(u'bmabru_project', 'activity_start',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.activity_end'
        db.add_column(u'bmabru_project', 'activity_end',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Project.trade_name'
        db.alter_column(u'bmabru_project', 'trade_name', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Project.activity_start'
        db.delete_column(u'bmabru_project', 'activity_start')

        # Deleting field 'Project.activity_end'
        db.delete_column(u'bmabru_project', 'activity_end')


        # Changing field 'Project.trade_name'
        db.alter_column(u'bmabru_project', 'trade_name', self.gf('django.db.models.fields.CharField')(max_length=512))
