...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerType.parent'
        db.add_column(u'bmabru_partnertype', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bmabru.PartnerType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.address_fr'
        db.add_column(u'bmabru_project', 'address_fr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.address_nl'
        db.add_column(u'bmabru_project', 'address_nl',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerType.parent'
        db.delete_column(u'bmabru_partnertype', 'parent_id')

        # Deleting field 'Project.address_fr'
        db.delete_column(u'bmabru_project', 'address_fr')

        # Deleting field 'Project.address_nl'
        db.delete_column(u'bmabru_project', 'address_nl')
